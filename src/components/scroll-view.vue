  ...
  export default {
    ...
    methods: {
      scrollFun(even) {
        ...
        if ((scrollHeight - scrollTop - clientHeight < bottomValue&&this.rollingDirection == "toLower")||(scrollWidth - scrollLeft - clientWidth < bottomValue&&this.rollingDirection == "toRight")) {
